            ...
            <div className='py-4'>
                ...
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        <h2 className="py-4 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight"> {t("dashboard.DistributionResident")}</h2>
                    </div>
                        ...
                        <Bar
                            ...
                            options={{
                                ...
                                plugins: {
                                    title: {
                                        display: true,
                                        text: t("dashboard.DistributionResident"),
                                        position: 'top',
                                        font: {
                                            weight: 'bold',
                                            size: 18,
